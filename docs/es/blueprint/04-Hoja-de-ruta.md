...
1. Delegación de Credenciales: Los usuarios humanos deben poder autorizar de forma segura a iFay para usar sus [credenciales](./02-Definición-y-concepto#aclaraciones-de-conceptos-generales) (cuentas, contraseñas, certificados, permisos de acceso, contratos, etc.) a través de un mecanismo de delegación controlable y auditable.
...
Comparado con la [Fase 1](./04-Hoja-de-ruta#1️⃣-fase-1-simulación-de-operaciones-humanas), iFay añade cinco nuevos módulos internos, comenzando con:
