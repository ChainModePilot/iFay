...
### GMChain
**Global Merit Chain**, una blockchain que gana tokens digitales midiendo contribuciones sociales identificables. A diferencia de la mayoría de los proyectos blockchain, este proyecto depende enteramente del reconocimiento del valor social para ganar tokens, en lugar de completar tareas computacionales predefinidas e indiscutibles dentro del proyecto. También acepta emisión dirigida respaldada por moneda fiduciaria, bonos, certificados de activos, oro y otras garantías para interactuar con los métodos de reconocimiento de valor del mundo real.

### MeriToken
Un token digital, una credencial digital cuantificada correspondiente a la contribución social. La adquisición se basa en crear valor social, en lugar de consumir poder de cómputo para completar trabajo técnico de blockchain.
