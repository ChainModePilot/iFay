...
| **对齐意识** | 对齐意识从个人数据堆中挖掘数据来构建宿主画像 | 从记忆中总结出"我是什么样的人" |
...
- **关联模块**：传感器（`SensorModule`）提供环境数据，外部知识（`ExternalKnowledge`）提供外部信息，对齐意识（`AlignedConsciousness`）从数据堆挖掘宿主画像
...
- [传感器](./Sensor) — 数据来源
- [外部知识](./External-Knowledge) — 知识整合
- [对齐意识](./Aligned-Consciousness) — 画像挖掘
- [从人类到 iFay](./Human-to-iFay) — 初始化数据
