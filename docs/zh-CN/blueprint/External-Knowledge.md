...
外部知识是 iFay 的**图书馆和专家顾问**——个人数据堆是 iFay 自己的记忆，外部知识是 iFay 可以查阅的图书馆和咨询的专家。它让 iFay 拥有超越宿主自身能力的知识。
...
| **对齐意识** | 对齐意识帮助筛选与宿主相关的外部知识 | 你的兴趣决定你去图书馆借什么书 |
| **内部技能** | 内部技能检查外部知识是否与宿主意图冲突 | 用自己的判断力评估外部信息的可信度 |
...
- [个人数据堆](./Personal-Data-Heap) — 知识存储
- [注册技能](./Registered-Skill) — 知识源注册
- [内部技能](./Internal-Skill) — 冲突检查
