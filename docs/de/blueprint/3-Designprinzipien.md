...
1. [Definition und Konzept](./2-Definition-und-Konzept)
...
2. [iFay-Anwendungsszenarien](./5-iFay-Anwendungsszenarien)
    ...
    - [Prime-Eigenschaften in iFay injizieren](./5-iFay-Anwendungsszenarien#prime-eigenschaften-in-ifay-injizieren)
    - [iFay mit externen Fähigkeiten ergänzen](./5-iFay-Anwendungsszenarien#ifay-mit-externen-fähigkeiten-ergänzen)
    - [Mensch-iFay-Interaktionsmethoden](./5-iFay-Anwendungsszenarien#mensch-ifay-interaktionsmethoden)
        - [Wie man iFay aktiviert](./5-iFay-Anwendungsszenarien#wie-man-ifay-aktiviert)
        - [iFays autonome Wahrnehmung](./5-iFay-Anwendungsszenarien#ifays-autonome-wahrnehmung)
        - [Wie man iFay herunterfährt](./5-iFay-Anwendungsszenarien#wie-man-ifay-herunterfährt)
    - [iFays soziale Funktionen](./5-iFay-Anwendungsszenarien#ifays-soziale-funktionen)
    - [Sicherheit](./5-iFay-Anwendungsszenarien#sicherheit)
    - [Gestaltung des KI-Industrie-Ökosystems](./5-iFay-Anwendungsszenarien#gestaltung-des-ki-industrie-ökosystems)

---

3. [iFay ist Replikation der menschlichen Persönlichkeit](./6-iFay-ist-Replikation-der-menschlichen-Persönlichkeit)
    ...
    - [Prime-Persönlichkeit](./6-iFay-ist-Replikation-der-menschlichen-Persönlichkeit#prime-persönlichkeit)
    - [Prime-Daten](./6-iFay-ist-Replikation-der-menschlichen-Persönlichkeit#prime-daten)
    - [Prime-Berechtigungen](./6-iFay-ist-Replikation-der-menschlichen-Persönlichkeit#prime-berechtigungen)

---

4. [iFay-Profil](./7-iFay-Profil)
    ...
    - [iFay-Identität](./7-iFay-Profil#ifay-identität)
    - [Ego-Modell](./7-iFay-Profil#ego-modell)
    - [Faying-Denken](./7-iFay-Profil#faying-denken)
        1. [Content](./7-iFay-Profil#content)
        2. [Data](./7-iFay-Profil#data)
        3. [Knowledge Base](./7-iFay-Profil#knowledge-base)
        4. [Info Feed](./7-iFay-Profil#info-feed)
    - [Faying-Skills](./7-iFay-Profil#faying-skills)
        1. [API](./7-iFay-Profil#api)
        2. [Workflow](./7-iFay-Profil#workflow)
        3. [Bot](./7-iFay-Profil#bot)
        4. [Agent](./7-iFay-Profil#agent)
        5. [APP](./7-iFay-Profil#app)
        6. [Microservice](./7-iFay-Profil#microservice)
    - [Faying-Hardware](./7-iFay-Profil#faying-hardware)
        1. [Device](./7-iFay-Profil#device)
        2. [Storage](./7-iFay-Profil#storage)
        3. [Computing](./7-iFay-Profil#computing)
    - [Faying-Berechtigungen](./7-iFay-Profil#faying-berechtigungen)
        1. [SSO](./7-iFay-Profil#sso)
        2. [OAuth](./7-iFay-Profil#oauth)
        3. [Fingerprint](./7-iFay-Profil#fingerprint)
