...
### GMChain
**Global Merit Chain**, eine Blockchain, die digitale Token durch die Messung identifizierbarer sozialer Beiträge verdient. Im Gegensatz zu den meisten Blockchain-Projekten basiert dieses Projekt vollständig auf der Anerkennung sozialen Werts, um Token zu verdienen, anstatt vordefinierte, unbestrittene Rechenaufgaben innerhalb des Projekts zu erledigen. Es akzeptiert auch gerichtete Ausgabe, die durch Fiat-Währung, Anleihen, Vermögenszertifikate, Gold und andere Sicherheiten gedeckt ist, um mit realen Wertanerkennungsmethoden zu interagieren.

### MeriToken
Ein digitaler Token, ein quantifizierter digitaler Nachweis, der dem sozialen Beitrag entspricht. Der Erwerb basiert auf der Schaffung sozialen Werts, anstatt Rechenleistung für technische Blockchain-Arbeit zu verbrauchen.
