...
1. Anmeldeinformationen-Delegation: Menschliche Nutzer müssen in der Lage sein, iFay sicher zu autorisieren, ihre [Anmeldeinformationen](./2-Definition-und-Konzept#allgemeine-begriffsklärungen) (Konten, Passwörter, Zertifikate, Zugriffsberechtigungen, Verträge usw.) durch einen kontrollierbaren und auditierbaren Delegationsmechanismus zu verwenden.
...
Im Vergleich zu [Phase 1](./4-Roadmap#1️⃣-phase-1-simulation-menschlicher-bedienung) fügt iFay fünf neue interne Module hinzu, beginnend mit:
