...
### GMChain
**Global Merit Chain**, une blockchain qui gagne des jetons numériques en mesurant les contributions sociales identifiables. Contrairement à la plupart des projets blockchain, ce projet repose entièrement sur la reconnaissance de la valeur sociale pour gagner des jetons, plutôt que sur l'accomplissement de tâches de calcul prédéfinies et incontestées au sein du projet. Il accepte aussi l'émission dirigée garantie par des monnaies fiduciaires, des obligations, des certificats d'actifs, de l'or et d'autres collatéraux pour s'interfacer avec les méthodes de reconnaissance de valeur du monde réel.

### MeriToken
Un jeton numérique, un justificatif numérique quantifié correspondant à la contribution sociale. L'acquisition est basée sur la création de valeur sociale, plutôt que sur la consommation de puissance de calcul pour accomplir du travail technique blockchain.
