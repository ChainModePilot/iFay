...
1. Délégation d'identifiants : Les utilisateurs humains doivent pouvoir autoriser de manière sécurisée iFay à utiliser leurs [identifiants](./2-Définition-et-concept#clarifications-de-concepts-généraux) (comptes, mots de passe, certificats, permissions d'accès, contrats, etc.) via un mécanisme de délégation contrôlable et auditable.
...
Comparé à la [Phase 1](./4-Feuille-de-route#1️⃣-phase-1-simulation-des-opérations-humaines), iFay ajoute cinq nouveaux modules internes, en commençant par :
