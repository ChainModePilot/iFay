...
- [Tas de données personnelles](./11.1-Tas-de-données-personnelles) — Exploration de données
- [Conscience de soi](./9.3-Conscience-de-soi) — Ajustement en temps réel
- [Compétences internes](./12.3-Compétences-internes) — Contraintes comportementales
- [Profil iFay](./7-Profil-iFay) — Le profil du Human Prime est un sous-ensemble du Profil
