...
### GMChain
**Global Merit Chain**, a blockchain that earns digital tokens by measuring identifiable social contributions. Unlike most blockchain projects, this project relies entirely on the recognition of social value to earn tokens, rather than completing predefined, undisputed computational tasks within the project. It also accepts directed issuance backed by fiat currency, bonds, asset certificates, gold, and other collateral to interface with real-world value recognition methods.

### MeriToken
A digital token, a quantified digital credential corresponding to social contribution. Acquisition is based on creating social value, rather than consuming computing power to complete blockchain technical work.
