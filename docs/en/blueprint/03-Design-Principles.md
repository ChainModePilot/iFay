...
1. [Definition and Concept](./02-Definition-and-Concept)
...
2. [iFay Application Scenarios](./05-Application-Scenarios)
    ...
    - [Injecting Prime Traits into iFay](./05-Application-Scenarios#injecting-prime-traits-into-ifay)
    - [Supplementing iFay with External Capabilities](./05-Application-Scenarios#supplementing-ifay-with-external-capabilities)
    - [Human-iFay Interaction Methods](./05-Application-Scenarios#human-ifay-interaction-methods)
        - [How to Activate iFay](./05-Application-Scenarios#how-to-activate-ifay)
        - [iFay's Autonomous Awareness](./05-Application-Scenarios#ifays-autonomous-awareness)
        - [How to Shut Down iFay](./05-Application-Scenarios#how-to-shut-down-ifay)
    - [iFay's Social Features](./05-Application-Scenarios#ifays-social-features)
    - [Security](./05-Application-Scenarios#security)
    - [Shaping the AI Industry Ecosystem](./05-Application-Scenarios#shaping-the-ai-industry-ecosystem)

---

3. [iFay Is a Replication of Human Personality](./06-iFay-Personality-Replication)
    ...
    - [Prime Personality](./06-iFay-Personality-Replication#prime-personality)
    - [Prime Data](./06-iFay-Personality-Replication#prime-data)
    - [Prime Permissions](./06-iFay-Personality-Replication#prime-permissions)

---

4. [iFay Profile](./07-iFay-Profile)
    ...
    - [iFay Identity](./07-iFay-Profile#ifay-identity)
    - [Ego Model](./07-iFay-Profile#ego-model)
    - [Faying Thinking](./07-iFay-Profile#faying-thinking)
        1. [Content](./07-iFay-Profile#content)
        2. [Data](./07-iFay-Profile#data)
        3. [Knowledge Base](./07-iFay-Profile#knowledge-base)
        4. [Info Feed](./07-iFay-Profile#info-feed)
    - [Faying Skills](./07-iFay-Profile#faying-skills)
        1. [API](./07-iFay-Profile#api)
        2. [Workflow](./07-iFay-Profile#workflow)
        3. [Bot](./07-iFay-Profile#bot)
        4. [Agent](./07-iFay-Profile#agent)
        5. [APP](./07-iFay-Profile#app)
        6. [Microservice](./07-iFay-Profile#microservice)
    - [Faying Hardware](./07-iFay-Profile#faying-hardware)
        1. [Device](./07-iFay-Profile#device)
        2. [Storage](./07-iFay-Profile#storage)
        3. [Computing](./07-iFay-Profile#computing)
    - [Faying Permissions](./07-iFay-Profile#faying-permissions)
        1. [SSO](./07-iFay-Profile#sso)
        2. [OAuth](./07-iFay-Profile#oauth)
        3. [Fingerprint](./07-iFay-Profile#fingerprint)
