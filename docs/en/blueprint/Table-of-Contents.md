...
- #### [10. Interaction Layer — Action](./10-Interaction-Layer-Action)
  ...
  - [10.1 Simulated Operation](./10-Interaction-Layer-Action#101-simulated-operation)
  - [10.2 Invoke Skill](./10-Interaction-Layer-Action#102-invoke-skill)
  - [10.3 Self-driven Behavior](./10-Interaction-Layer-Action#103-self-driven-behavior)

- #### [11. Cognition Layer — Thinking](./11-Cognition-Layer-Thinking)

  - [11.1 Personal Data Heap](./11-Cognition-Layer-Thinking#111-personal-data-heap)
  - [11.2 External Knowledge](./11-Cognition-Layer-Thinking#112-external-knowledge)
  - [11.3 Aligned Consciousness](./11-Cognition-Layer-Thinking#113-aligned-consciousness)

- #### [12. Cognition Layer — Skills](./12-Cognition-Layer-Skills)

  - [12.1 Device Driver Hub](./12-Cognition-Layer-Skills#121-device-driver-hub)
  - [12.2 Registered Skill](./12-Cognition-Layer-Skills#122-registered-skill)
  - [12.3 Internal Skill](./12-Cognition-Layer-Skills#123-internal-skill)

- #### [Ego Layer](https://github.com/ChainModePilot/Ego/wiki)

- #### [13. FayManifest Declarative Assembly](./13-FayManifest)

- #### [14. iFACTS Conformance Verification](./14-iFACTS)

- #### [15. Guardianship and Personality Continuity](./15-Guardianship)
...
- #### Developer Guide
  ...
  - Application Developers
    - APP Support for Faying with iFay
    - Hardware Device Support for Faying with iFay
    - Cloud Deployment of FayGer Runtime Environment
    - Sharing Skills with iFay
    - Modular Multimodal Messaging
  - Service Provider Developers
    - Developing and Building iFay Entities
