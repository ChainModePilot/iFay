...
1. Credential Delegation: Human users must be able to securely authorize iFay to use their [credentials](./02-Definition-and-Concept#general-concept-clarifications) (accounts, passwords, certificates, access permissions, contracts, etc.) through a controllable and auditable delegation mechanism.
...
Compared to [Phase 1](./04-Roadmap#1️⃣-phase-1-simulating-human-operations), iFay adds five new internal modules, starting with:
